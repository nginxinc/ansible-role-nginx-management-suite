...
* This role was developed and tested using **nginxinc.nginx** version **0.24.0**.
  * UPDATE 6/24/24: Use the edge *nginxinc.nginx* version, example of `requirements.yml` shown [here](https://github.com/nginxinc/ansible-role-nginx-management-suite/blob/main/.github/workflows/requirements/requirements_ansible.yml)
